<section class="menu menu1 cid-sBOHoABUOH" once="menu" id="menu1-0">
		...
		<div class="container">
			...
			<span class="navbar-caption-wrap"><a class="navbar-caption text-info display-2" href="index.php">EXPENSE Tracker&nbsp;</a></span>
		    </div>
			...
			<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
			    ...
			    <li class="nav-item"><a class="nav-link link text-warning display-7" href="charts.php">Charts</a></li>
			    <?php
			    if(!ss()){
